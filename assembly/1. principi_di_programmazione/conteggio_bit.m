...
.note.gnu.property
 ...
 .note.gnu.property
                0x0000000000400120       0x20 conteggio_bit.o
 ...
 *(.rela.dtors)
 *(.rela.got)
 .rela.got      0x0000000000400140        0x0 conteggio_bit.o
 ...
 *(.rela.iplt)
 .rela.iplt     0x0000000000400140        0x0 conteggio_bit.o
 ...
 *(.plt)
 *(.iplt)
 .iplt          0x0000000000401000        0x0 conteggio_bit.o
...
.text           0x0000000000401000       0xb1
 *(.text.unlikely .text.*_unlikely .text.unlikely.*)
 *(.text.exit .text.exit.*)
 *(.text.startup .text.startup.*)
 *(.text.hot .text.hot.*)
 *(.text .stub .text.* .gnu.linkonce.t.*)
 .text          0x0000000000401000       0xb1 conteggio_bit.o
 ...
 *(.got)
 .got           0x0000000000402000        0x0 conteggio_bit.o
 *(.igot)
                0x0000000000402000                . = DATA_SEGMENT_RELRO_END (., (SIZEOF (.got.plt) >= 0x18)?0x18:0x0)

.got.plt        0x0000000000402000        0x0
 *(.got.plt)
 .got.plt       0x0000000000402000        0x0 conteggio_bit.o
 *(.igot.plt)
 .igot.plt      0x0000000000402000        0x0 conteggio_bit.o

.data           0x0000000000402000        0x6
 *(.data .data.* .gnu.linkonce.d.*)
 .data          0x0000000000402000        0x6 conteggio_bit.o
 ...
 *(.bss .bss.* .gnu.linkonce.b.*)
 .bss           0x0000000000402006        0x0 conteggio_bit.o
 *(COMMON)
 ...
 *(.gnu_debuglink)
 *(.gnu.lto_*)
OUTPUT(conteggio_bit elf64-x86-64)
