 ...
 *(.rela.dtors)
 *(.rela.got)
 .rela.got      0x00000000004000e8        0x0 codifica.o
 ...
 *(.rela.iplt)
 .rela.iplt     0x00000000004000e8        0x0 codifica.o
 ...
 *(.plt)
 *(.iplt)
 .iplt          0x0000000000401000        0x0 codifica.o
...
.text           0x0000000000401000       0xa6
 *(.text.unlikely .text.*_unlikely .text.unlikely.*)
 *(.text.exit .text.exit.*)
 *(.text.startup .text.startup.*)
 *(.text.hot .text.hot.*)
 *(.text .stub .text.* .gnu.linkonce.t.*)
 .text          0x0000000000401000       0xa6 codifica.o
 ...
 *(.got)
 .got           0x0000000000402000        0x0 codifica.o
 *(.igot)
                0x0000000000402000                . = DATA_SEGMENT_RELRO_END (., (SIZEOF (.got.plt) >= 0x18)?0x18:0x0)

.got.plt        0x0000000000402000        0x0
 *(.got.plt)
 .got.plt       0x0000000000402000        0x0 codifica.o
 *(.igot.plt)
 .igot.plt      0x0000000000402000        0x0 codifica.o

.data           0x0000000000402000        0x1
 *(.data .data.* .gnu.linkonce.d.*)
 .data          0x0000000000402000        0x1 codifica.o

.data1
 *(.data1)
                0x0000000000402001                _edata = .
                [!provide]                        PROVIDE (edata = .)
                0x0000000000402001                . = .
                0x0000000000402001                __bss_start = .

.bss            0x0000000000402001        0x0
 *(.dynbss)
 *(.bss .bss.* .gnu.linkonce.b.*)
 .bss           0x0000000000402001        0x0 codifica.o
 *(COMMON)
                0x0000000000402001                . = ALIGN ((. != 0x0)?0x8:0x1)
